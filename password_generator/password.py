...
Title = Label (root, text="Password Generator", bg="light green",fg="black", font=("futura", 15, "bold"))
Title.pack(anchor="center", pady="20px")

length=Label(root, text="Select the Length of Your Password :-", fg="black", bg="light green",font=("ubuntu", 12))
...
generate_btn = Button(root, text="Generate Password", bg="#f75252",fg="black", font=("ubuntu", 15), cursor="hand2",command=password_generate)
generate_btn.bind("<Enter>",on_enter)
generate_btn.bind("<Leave>",on_leave)
generate_btn.pack(anchor="center", pady="50px")

result_lable=Label(root, text="Generated Password Here :-",bg="light green", fg="darkgreen", font=("ubuntu",12))
